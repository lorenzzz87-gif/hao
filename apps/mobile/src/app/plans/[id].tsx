    ...
    <ThemedView style={styles.screen}>
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <ThemedView type="backgroundElement" style={styles.card}><ThemedText type="smallBold">{t('plan.meetingPlace')}</ThemedText><ThemedText>{data.venue.name ?? t('plan.publicPlace')}</ThemedText>{data.venue.address && <ThemedText type="small" themeColor="textSecondary">{data.venue.address}</ThemedText>}<ThemedText type="small" themeColor="textSecondary">{t('plan.publicRecommended')}</ThemedText></ThemedView>
